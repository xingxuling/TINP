...
从已核对远端的 alpha.5 / a86623e93b18f783f402b12e9f93b198ff32ea6e 继续，候选分支 `codex/tinp-registry-v06`，当前 alpha.7 提交将在本轮验证后绑定。完整最终验收以 `evidence/0.1.0-alpha.7/LOCAL_VERIFICATION.json` 的源码哈希、退出码及运行见证为准。
